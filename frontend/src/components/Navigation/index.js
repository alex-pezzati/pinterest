...
function Navigation({ isLoaded }) {
    ...
    if (sessionUser) {
        ...
        sessionLinks = (
            <>
                <div>
                    <button className={c.login} onClick={openLogIn}>
                        Log In
                    </button>
                    <LoginFormPage />
                </div>
                <div>
                    <button className={c.signup} onClick={openSignUp}>
                        Sign Up
                    </button>
                    <SignupFormPage />
                </div>
        ...
        <div className={c.bar}>
            <div>
                <NavLink exact to="/" className={c.container}>
                    ...
                    <h3 className={c.pinterest}>Pinterest</h3>
                </NavLink>
            </div>
            <div className={c.container}>{isLoaded && sessionLinks}</div>
        </div>
    );
}
